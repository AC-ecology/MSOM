...
saveRDS(object = scen1,file = paste0(scenario, model.type, "seed", seed,
                                    "_simResults_v2.rds" ))
...
saveRDS(object = scencov.2,file = paste0(scenario, model.type, "seed", seed,
                                         "_simResults_v2.rds" ))
...
saveRDS(object = scencov.3,file = paste0(scenario, model.type, "seed", seed,
                                         "_simResults_v2.rds" ))
...
saveRDS(object = scen.3sp,file = paste0(scenario, model.type, "seed", seed,
                                         "_simResults_v2.rds" ))

scen.3sp$time.ellapsed
...
saveRDS(object = scen.4sp,file = paste0(scenario, model.type, "seed", seed,
                                        "_simResults_v2.rds" ))
#### 5 species ----
...
saveRDS(object = scen.5sp,file = paste0(scenario, model.type, "seed", seed,
                                        "_simResults_v2.rds" ))


hola <- read_rds("Scenario1_5spNullseed1337_simResults_v2.rds")
