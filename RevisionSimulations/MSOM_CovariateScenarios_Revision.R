...
# Scenario cov1: Modifier of interaction (A, B, C) ------
...
## beta2: baseline occupancy of sp2
...
# f1 = beta1.0 + beta1.1*occ_cov1 
# f2 = beta2.0 + beta2.1*occ_cov2
# f12 = beta12.0 + beta12.1*occ_cov3 
...
scenario <- "Scenario1_"
model.type = "CovariateModifier"

saveRDS(object = scencov.1,file = paste0("RevisionSimulations/Results/",scenario, model.type, "seed", seed,
                                         "_simResults.rds" ))

# Scenario cov2:  Shared interaction (A, B, A) --------
...
# f1 = beta1.0 + beta1.1*occ_cov1 
# f2 = beta2.0 + beta2.1*occ_cov2
# f12 = beta12.0 + beta12.1*occ_cov1 
...
scenario <- "Scenario2_"
model.type = "CovariateShared"

saveRDS(object = scencov.2,file = paste0("RevisionSimulations/Results/",scenario, model.type, "seed", seed,
                                         "_simResults.rds" ))
# Scenario cov3: Modifier of interaction (A, B, C+A) ------
...
# f1 = beta1.0 + beta1.1*occ_cov1 
# f2 = beta2.0 + beta2.1*occ_cov2
# f12 = beta12.0 + beta12.1*occ_cov3 + beta12.2*occ_cov1 


occ_formulas <- c("~occ_cov1",          #f1
                  "~occ_cov2",          #f2
                  "~occ_cov3 + occ_cov1")          #f12
nocc_covs = 3
...
scenario <- "Scenario3_"
model.type = "CovariateSharedModifier"

saveRDS(object = scencov.3,file = paste0("RevisionSimulations/Results/",scenario, model.type, "seed", seed,
                                         "_simResults.rds" ))
